    ...
    <div className="m-portlet__body" style={{ padding: "20px", background: "#f9f9f9", borderRadius: "8px" }}>
      ...
      <Row>
        <Col span={24} style={{ textAlign: "center", marginBottom: "20px" }}>
          <h1 style={{ fontSize: "24px", fontWeight: "bold", color: "#007bff" }}>Đồng bộ dữ liệu cơ cấu </h1>
        </Col>
      </Row>
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={18}>
          <label style={{ fontSize: "16px", color: "#555" }}>https://madinhdanh.hatinh.gov.vn</label>
        </Col> */}
          <Col span={24}>
          <label style={{ fontWeight: "bold", fontSize: "16px", color: "#555" }}>Url nguồn:</label>
      ...
      <Row gutter={[16, 16]}>
        <Col span={24} style={{ textAlign: "center" }}>
          ...
          <Button
            type="primary"
            style={{ display: "none", padding: "10px 20px", borderRadius: "4px" }}
          >
            Đồng bộ người dùng
          </Button>
          <Button
            style={{ display: "none", padding: "10px 20px", borderRadius: "4px" }}
          >
            Đồng bộ chuyển nhóm người dùng
          </Button>
        </Col>
      </Row>
    </div>
