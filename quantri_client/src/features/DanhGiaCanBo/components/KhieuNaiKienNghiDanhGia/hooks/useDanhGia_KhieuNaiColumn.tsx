...
import { EyeOutlined, PlayCircleOutlined, PlusCircleOutlined, SendOutlined } from '@ant-design/icons';
import { useKhieuNaiDanhGiaContext } from '../contexts/useKhieuNaiKienNghiContext';

export const useKhieuNai_DanhGiaTableColumn = ({ pageNumber = 1, pageSize = 10 }: {
                ...
                render: (_, record) => {
                    ...
                    return (
                        <Space direction="horizontal">
                            ...
                            <SendOutlined style={{ color: '#ffa500' }} title="Kiến nghị đánh giá"
                                onClick={() => {
