...
import { Form, Input, Space, Row, Col, Checkbox, Collapse, Divider } from "antd"
...
function HeaderThemDanhGiaKhieuNaiDetailModal({ form }: {
    form: FormInstance<IDanhGia>
}) {
                ...
                <Col span={24} >
                    ...
                    >
                        <RegularUpload
                            ...
                            hideUpload={buttonActionContext.readOnlyKhieuNaiModalVisible}
                        />
                    </Form.Item>
                </Col>
                {!danhGiaContext.hasKetQuaKhieuNai ? null :
                    <>
                        ...
                        <Col span={24} >
                            <Form.Item
                                label="Kết quả giải quyết kiến nghị"
                                name="ketQua"
                                labelCol={{ span: 4 }}
                                wrapperCol={{ span: 20 }}
                            >
                                <Input.TextArea style={{ width: '100%' }} placeholder="Nội dung giải quyết kiến nghị đánh giá..."
                                    disabled={buttonActionContext.readOnlyKhieuNaiModalVisible} />
                            </Form.Item>
                        </Col>
...
export default HeaderThemDanhGiaKhieuNaiDetailModal;