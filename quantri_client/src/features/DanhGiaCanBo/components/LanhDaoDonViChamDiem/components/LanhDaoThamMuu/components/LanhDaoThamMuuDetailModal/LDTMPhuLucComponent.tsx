...
import { useMauPhieuLanhDaoThamMuuChamDiemColumn } from "../../hooks/useMauPhieuLDTMChamDiemColumn";



function PhuLucComponentLanhDaoThamMuuChamDiem({ dataRoot, scorePoint, updateData, updatePoint }: {
    ...
    const columns = useMauPhieuLanhDaoThamMuuChamDiemColumn({
        dataRoot,
        scorePoint,
        dataSource,
        setDataSource,
...
export default PhuLucComponentLanhDaoThamMuuChamDiem;
