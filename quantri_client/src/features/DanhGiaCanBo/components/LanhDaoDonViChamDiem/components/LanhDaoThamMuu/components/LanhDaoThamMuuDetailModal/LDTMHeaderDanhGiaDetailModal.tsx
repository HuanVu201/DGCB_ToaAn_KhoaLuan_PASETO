...
function HeaederLanhDaoThamMuuChamDiemDetailModal({ form, diemDanhGiaTotal }: {
    ...
    return (<>
        <Form name='MauPhoiSearch' layout="horizontal" form={form}>
            <Row gutter={[0, 12]}>
                ...
                <Col sm={8} span={24} >
                    <Form.Item
                        label="Điểm Phó thủ trưởng cơ quan, đơn vị chấm"
                        name="diemThamMuu"
                        labelCol={{ span: 12 }}
                        wrapperCol={{ span: 12 }}
                    >
...
export default HeaederLanhDaoThamMuuChamDiemDetailModal;