...
import LanhDaoThamMuuChamDiemDetailModal from "./LanhDaoThamMuuDetailModal/LDTMDanhGiaDetailModal";
...
import { useLDTMChoThamMuuColumn } from "../hooks/useLDTMChoThamMuuColumn";
...
import { TrangThai_ChoThamMuu } from "@/features/DanhGiaCanBo/components/common/TenVetXuLyConstants";


function LanhDaoThamMuuChoChamDiemTable() {
    ...
    const searchParamOrigins: ISearchDanhGiaCanBo = {
        ...
        trangThai: TrangThai_ChoThamMuu,
        loaiNgay: 'TuDanhGia',
        type: 'ThamMuuDanhGia',
        ...
        },
        {
            icon: <EditOutlined title="Tham mưu chấm điểm"
                onClick={() => {
                    ...
                    buttonActionContext.setLanhDaoThamMuuChamDiemModalVisible(true)
                }} />,
            key: 'CapNhat'
        },
        {
    ...
    const columns = useLDTMChoThamMuuColumn({ pageNumber: searchParams.pageNumber ?? 1, pageSize: searchParams.pageSize ?? 10, tableActions })
    ...
    const rowSelection: TableRowSelection<IDanhGiaCanBo> = {
        ...
        getCheckboxProps: (record) => ({
            disabled: record.diemThamMuu === null,
        }),
    };
    ...
    return (<div className="LanhDaoChoChamDiemSwapper">
        ...
        >
            ...
            <VetXuLyDanhGiaTable />
            <LanhDaoThamMuuChamDiemDetailModal />
...
const LanhDaoThamMuuChoChamDiemTableSwapper = () => (
    <ButtonActionProvider>
        <LanhDaoThamMuuChamDiemProvider>
            <LanhDaoThamMuuChoChamDiemTable />
        </LanhDaoThamMuuChamDiemProvider>
    </ButtonActionProvider>
);


export default LanhDaoThamMuuChoChamDiemTableSwapper;