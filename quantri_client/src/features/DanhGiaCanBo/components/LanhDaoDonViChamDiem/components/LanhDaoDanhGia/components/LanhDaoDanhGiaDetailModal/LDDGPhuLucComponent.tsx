...
import { useMauPhieuLanhDaoDanhGiaChamDiemColumn } from "../../hooks/useMauPhieuLDDGChamDiemColumn";



function PhuLucComponentLanhDaoDanhGiaChamDiem({ dataRoot, scorePoint, updateData, updatePoint }: {
    ...
    const columns = useMauPhieuLanhDaoDanhGiaChamDiemColumn({
        dataRoot,
        scorePoint,
        dataSource,
        setDataSource,
...
export default PhuLucComponentLanhDaoDanhGiaChamDiem;
