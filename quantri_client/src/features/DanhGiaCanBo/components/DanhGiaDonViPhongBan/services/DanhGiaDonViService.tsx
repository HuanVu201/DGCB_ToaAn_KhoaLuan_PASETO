...
import { IDanhGiaCanBo, IDuyetDanhGia, ISearchDanhGiaCanBo, ITraLaiThuHoiPhieuDanhGia, IUserDanhGia, IXoaDiemLanhDaoCham } from "../../common/models";
import { IUrlPhieuDanhGia } from "../../common/models/phieuDanhGia";


class DanhGiaDonViService extends Service.BaseApi implements Service.ICrud<IDanhGiaCanBo> {
    constructor() {
        super("danhgiadonvis")
    }
...
export const danhGiaDonViServiceApi = new DanhGiaDonViService()