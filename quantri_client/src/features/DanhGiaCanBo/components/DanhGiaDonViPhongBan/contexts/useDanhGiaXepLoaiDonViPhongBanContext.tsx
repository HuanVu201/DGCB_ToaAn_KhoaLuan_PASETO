...
const DanhGiaXepLoaiDonViPhongBanContext = createContext<IDanhGiaXepLoaiDonViPhongBanContext | null>(null)

export interface IDanhGiaXepLoaiDonViPhongBanContext {
...
export const useDanhGiaXepLoaiDonViPhongBanContext = () => {
    const context = useContext(DanhGiaXepLoaiDonViPhongBanContext)
    if (!context)
        throw new Error("DanhGiaXepLoaiDonViPhongBanContext must be used inside DanhGiaXepLoaiDonViPhongBanContext.Provider")
    return context
}

export const DanhGiaXepLoaiDonViPhongBanProvider = ({ children }: IWithChildren) => {
    ...
    return <DanhGiaXepLoaiDonViPhongBanContext.Provider value={{
        ...
        {children}
    </DanhGiaXepLoaiDonViPhongBanContext.Provider>
}