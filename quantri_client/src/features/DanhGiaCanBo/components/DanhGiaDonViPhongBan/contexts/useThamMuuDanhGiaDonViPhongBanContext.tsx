...
const ThamMuuDanhGiaDonViPhongBanContext = createContext<IThamMuuDanhGiaDonViPhongBanContext | null>(null)

export interface IThamMuuDanhGiaDonViPhongBanContext {
...
export const useThamMuuDanhGiaDonViPhongBanContext = () => {
    const context = useContext(ThamMuuDanhGiaDonViPhongBanContext)
    if (!context)
        throw new Error("ThamMuuDanhGiaDonViPhongBanContext must be used inside ThamMuuDanhGiaDonViPhongBanContext.Provider")
    return context
}

export const ThamMuuDanhGiaDonViPhongBanProvider = ({ children }: IWithChildren) => {
    ...
    return <ThamMuuDanhGiaDonViPhongBanContext.Provider value={{
        ...
        {children}
    </ThamMuuDanhGiaDonViPhongBanContext.Provider>
}