...
import { TrangThai_ChoThamMuu } from '../../common/TenVetXuLyConstants';

export const useTableThamMuuDanhGiaDonViPhongBanColumn = ({ pageNumber = 1, pageSize = 10, tableActions }: {
        ...
        return [
            ...
            },
            {
                ...
                render: (_, record) => {
                    ...
                    if (record.trangThai != TrangThai_ChoThamMuu)
