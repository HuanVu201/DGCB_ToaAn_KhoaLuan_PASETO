...
export const useMauPhieuThamMuuDanhGiaDonViPhongBanColumn = ({
    dataRoot,
    scorePoint,
    dataSource,
    setDataSource,
                    ...
                    if (item.MaTieuChi === record.MaTieuChi) {
                        ...
                        if (colName === 'isGiaiTrinhTM') {
                            ...
                            if (updatedItem.DuocChamNhieuLan || updatedItem.DiemThuong || updatedItem.DiemTru) {
                                updatedItem.isGiaiTrinhTM = updatedItem.DiemThamMuu != diemPrev
    ...
    const columns: TableColumnsType<IDanhGiaColumn> = useMemo(
        () => {
            ...
            baseColumns.push({
                title: <p style={{ textAlign: 'center' }}>Điểm đơn vị, bộ phận tham mưu</p>,
            ...
            baseColumns.push({
                ...
                width: '2%',
                render: (text: string, record: IDanhGiaColumn) => {
                    if (record.NoiDungGiaiTrinh || record.NoiDungGiaiTrinhTM || record.NoiDungGiaiTrinhDG)
                        return (
                            <>
