...
import { useMauPhieuThamMuuDanhGiaDonViPhongBanColumn } from "../../../hooks/useMauPhieuThamMuuDanhGiaDonViPhongBanColumn";



function PhuLucThamMuuDanhGiaDonViPhongBanComponent({ dataRoot, scorePoint, updateData, updatePoint }: {
    ...
    const columns = useMauPhieuThamMuuDanhGiaDonViPhongBanColumn({
        dataRoot,
        scorePoint,
        dataSource,
        setDataSource,
...
export default PhuLucThamMuuDanhGiaDonViPhongBanComponent;
