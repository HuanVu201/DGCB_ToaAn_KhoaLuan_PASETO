...
import { useMauPhieuDanhGiaXepLoaiDonViPhongBanColumn } from "../../../hooks/useMauPhieuDanhGiaXepLoaiDonViPhongBanColumn";

function PhuLucDanhGiaXepLoaiDonViPhongBanComponent({ dataRoot, scorePoint, updateData, updatePoint }: {
    ...
    const columns = useMauPhieuDanhGiaXepLoaiDonViPhongBanColumn({
        dataRoot,
        scorePoint,
        dataSource,
        setDataSource,
...
export default PhuLucDanhGiaXepLoaiDonViPhongBanComponent;
