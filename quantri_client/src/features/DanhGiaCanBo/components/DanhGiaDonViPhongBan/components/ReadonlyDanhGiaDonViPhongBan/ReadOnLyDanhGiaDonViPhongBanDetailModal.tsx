...
import '../../../../components/common/PhieuChamDiem.scss'
...
import HeaderReadOnlyDanhGiaDonViPhongBanDetailModal from "./HeaderReadOnlyDanhGiaDonViPhongBanDetailModal";
import { ReadonlyDanhGiaDonViPhongBanProvider, useReadonlyDanhGiaDonViPhongBanContext } from "../../contexts/useReadonlyDanhGiaDonViPhongBanContext";
import LichSuDanhGiaModal from "../../../common/components/LichSuDanhGia/LichSuDanhGiaModal";
import PhuLucReadOnLyDanhGiaDonViPhongBanComponents from "./PhuLucReadOnLyDanhGiaDonViPhongBanComponents";
import { danhGiaDonViServiceApi } from "../../services/DanhGiaDonViService";



const ReadOnLyDanhGiaDonViPhongBanDetailModalVisible = () => {
    ...
    useEffect(() => {
        (async () => {
            if (buttonActionContext.danhGiaId && buttonActionContext.readOnlyDanhGiaDonViPhongBanModalVisible) {
    ...
    const handlerCancel = () => {
        ...
        buttonActionContext.setReadOnlyDanhGiaDonViPhongBanModalVisible(false)
        ...
        return ({
            ...
            children: (
                <div style={{ display: activeTab === item.key ? 'block' : 'none' }}>
                    <PhuLucReadOnLyDanhGiaDonViPhongBanComponents
    ...
    return <AntdModal className="chamDiemModal" visible={buttonActionContext.readOnlyDanhGiaDonViPhongBanModalVisible} title={"Xem thông tin chấm điểm"} fullsizeScrollable handlerCancel={handlerCancel}
        footer={[
            <>
    ...
    >
        ...
        >
            <HeaderReadOnlyDanhGiaDonViPhongBanDetailModal form={form} diemDanhGiaTotal={diemDanhGiaTotal.current} />
            <AntdTab
...
const ReadOnLyDanhGiaDonViPhongBanDetailModal = () => (
    <ReadonlyDanhGiaDonViPhongBanProvider>
        <ReadOnLyDanhGiaDonViPhongBanDetailModalVisible />
    </ReadonlyDanhGiaDonViPhongBanProvider>
);


export default ReadOnLyDanhGiaDonViPhongBanDetailModal