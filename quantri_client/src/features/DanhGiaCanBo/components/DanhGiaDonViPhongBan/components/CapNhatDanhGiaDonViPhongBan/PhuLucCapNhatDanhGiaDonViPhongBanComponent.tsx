...
import { useMauPhieuCapNhatDanhGiaDonViPhongBanColumn } from "../../hooks/useMauPhieuCapNhatDanhGiaDonViPhongBanColumn";



function PhuLucCapNhatDanhGiaDonViPhongBanComponent({ dataRoot, scorePoint, updateData, updatePoint }: {
    ...
    const columns = useMauPhieuCapNhatDanhGiaDonViPhongBanColumn({
        dataRoot,
        scorePoint,
        dataSource,
        setDataSource,
...
export default PhuLucCapNhatDanhGiaDonViPhongBanComponent;
