...
import { useMauPhieuTaoDanhGiaDonViPhongBanColumn } from "../../../hooks/useMauPhieuTaoDanhGiaDonViPhongBanColumn";




function PhuLucDanhGiaDonViPhongBanComponent({ dataRoot, scorePoint, updateData, updatePoint }: {
    ...
    const columns = useMauPhieuTaoDanhGiaDonViPhongBanColumn({
        dataRoot,
        scorePoint,
        dataSource,
        setDataSource,
...
export default PhuLucDanhGiaDonViPhongBanComponent;
