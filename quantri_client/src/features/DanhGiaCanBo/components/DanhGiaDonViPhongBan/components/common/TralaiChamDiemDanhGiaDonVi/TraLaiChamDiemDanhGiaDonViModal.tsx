...
function TraLaiChamDiemDanhGiaDonViModal({ reload, setReload }: {
    reload: boolean;
    ...
    const onFinish = async () => {
        ...
        if (data.lyDo) {
            try {
                ...
                const resRollBackPhieu = await danhGiaDonViServiceApi.TraLaiPhieuDanhGia({
...
export default TraLaiChamDiemDanhGiaDonViModal;