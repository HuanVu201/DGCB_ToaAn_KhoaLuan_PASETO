...
function ThuHoiChamDiemDanhGiaDonViModal({ reload, setReload }: {
    reload: boolean;
    ...
    const onFinish = async (value: any) => {
        ...
        if (data.lyDo) {
            try {
                ...
                const resRollBackPhieu = await danhGiaDonViServiceApi.ThuHoiPhieuDanhGia({
...
export default ThuHoiChamDiemDanhGiaDonViModal;