...
import { useMauPhieuLanhDaoTrucTiepChamDiemColumn } from "../../hooks/useMauPhieuLDNXChamDiemColumn";



function PhuLucComponentLanhDaoTrucTiepChamDiem({ dataRoot, scorePoint, updateData, updatePoint }: {
    ...
    const columns = useMauPhieuLanhDaoTrucTiepChamDiemColumn({
        dataRoot,
        scorePoint,
        dataSource,
        setDataSource,
...
export default PhuLucComponentLanhDaoTrucTiepChamDiem;
