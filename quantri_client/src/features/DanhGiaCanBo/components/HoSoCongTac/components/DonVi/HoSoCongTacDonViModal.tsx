...
const HoSoCongTacDonViModalVisible = () => {
    ...
    return <AntdModal className="" visible={hoSoContext.hoSoModalVisible && hoSoContext.hoSoId ? true : false} title={`Thông tin hồ sơ công tác đánh giá đơn vị`} width={900} handlerCancel={handlerCancel}
        footer={[
            <Button
                type="primary"
                onClick={() => onFinish()}
        ...
        >
            <Form name='HoSoCongTacModal' layout="vertical" form={form} >
                <Row gutter={[0, 0]}>
                    ...
                    <Col span={24} >
                        <Form.Item
                            label="2. Biên bản hội nghị kiểm điểm:"
                    ...
                    <Col span={24} >
                        <Form.Item
                            label="3. Tổng hợp kết quả thẩm định của cơ quan chủ trì tham mưu, giúp việc:"
                    ...
                    <Col span={24} >
                        <Form.Item
                            label="4. Kết luận đánh giá, kết quả xếp loại của cấp có thẩm quyền:"
                    ...
                    <Col span={24} >
                        <Form.Item
                            label="5. Văn bản gợi ý kiểm điểm (nếu có):"
                    ...
                    <Col span={24} >
                        <Form.Item
                            label="6. Văn bản tham gia, góp ý của các tổ chức, tập thể, cá nhân có liên quan (nếu có):"
                    ...
                    <Col span={24} >
                        <Form.Item
                            label="7. Hồ sơ giải quyết khiếu nại, kiến nghị về việc kết quả đánh giá, xếp loại (nếu có):"
                    ...
                    <Col span={24} >
                        <Form.Item
                            label="8. Các văn bản khác (nếu có):"
...
const HoSoCongTacDonViModal = () => (
    <HoSoCongTacDonViModalVisible />
);


export default HoSoCongTacDonViModal