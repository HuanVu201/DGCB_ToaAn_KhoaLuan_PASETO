...
export const useChoLanhDaoTrucTiepChamDiemColumn = ({ pageNumber = 1, pageSize = 10, tableActions }: {
  ...
  const columns = useMemo((): ColumnsType<IDanhGiaCanBo> => {
    return [
      ...
      {
        title: <p style={{ textAlign: 'center' }}>Lãnh đạo nhận xét</p>,
        key: "nguoiNhanXet",
        dataIndex: "nguoiNhanXet",
        align: 'center'
      },
      {
