...
function HeaederDanhGiaDetailModal({ form, diemDanhGiaTotal, currNode }: {
    ...
    useEffect(() => {
        if (buttonActionContext.danhGiaModalVisible && danhGiaContext.userDanhGia) {
    ...
    }, [buttonActionContext.danhGiaModalVisible, danhGiaContext.userDanhGia])
...
export default HeaederDanhGiaDetailModal;