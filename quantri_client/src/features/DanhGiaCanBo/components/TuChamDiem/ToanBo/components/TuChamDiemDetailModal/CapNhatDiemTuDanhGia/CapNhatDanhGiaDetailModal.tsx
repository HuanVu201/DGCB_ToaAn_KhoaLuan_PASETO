...
import { IPhuLucItem } from "../DanhGiaDetailModal";
import PhuLucCapNhatComponent from "./PhuLucCapNhatComponent";
import HeaderCapNhatTuChamDiemDetailModal from "./HeaderCapNhatDanhGiaDetailModal";


const CapNhatTuChamDiemDetailModalVisible = () => {
    ...
    useEffect(() => {
        (async () => {
            if (!danhGiaContext.userDanhGia && buttonActionContext.capNhatDanhGiaModalVisible && buttonActionContext.danhGiaId) {
    ...
    }, [danhGiaContext.userDanhGia, buttonActionContext.capNhatDanhGiaModalVisible])

    useEffect(() => {
        (async () => {
            if (danhGiaContext.userDanhGia && !danhGiaContext.nextNode && buttonActionContext.capNhatDanhGiaModalVisible && !danhGiaContext.disableDanhGia) {
    ...
    useEffect(() => { // Chấm điểm, nhận xét
        (async () => {
            if (buttonActionContext.danhGiaId && buttonActionContext.capNhatDanhGiaModalVisible) {
    ...
    const handlerCancel = () => {
        ...
        buttonActionContext.setCapNhatDanhGiaModalVisible(false)
    ...
    return <AntdModal className="chamDiemModal" visible={buttonActionContext.capNhatDanhGiaModalVisible} title={"Thông tin chấm điểm, xếp loại"} fullsizeScrollable handlerCancel={handlerCancel}
        footer={[
            <>
    ...
    >
        ...
        >
            <HeaderCapNhatTuChamDiemDetailModal form={form} diemDanhGiaTotal={diemDanhGiaTotal.current} />
...
const CapNhatTuChamDiemDetailModal = () => (
    <CapNhatDanhGiaProvider>
        <CapNhatTuChamDiemDetailModalVisible />
    </CapNhatDanhGiaProvider>
);


export default CapNhatTuChamDiemDetailModal