...
import { useFormCapNhatDanhGiaColumn } from "../../../hooks/useCapNhatMauPhieuTuDanhGiaModalColumn";



function PhuLucCapNhatComponent({ dataRoot, scorePoint, updateData, updatePoint }: {
    ...
    const columns = useFormCapNhatDanhGiaColumn({
        dataRoot,
        scorePoint,
        dataSource,
        setDataSource,
...
export default PhuLucCapNhatComponent;
