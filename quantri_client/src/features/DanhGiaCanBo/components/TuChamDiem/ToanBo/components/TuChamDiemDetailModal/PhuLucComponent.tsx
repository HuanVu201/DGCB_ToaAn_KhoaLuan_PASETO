...
import { useFormDanhGiaColumn } from "../../hooks/useMauPhieuModalColumn";



function PhuLucComponent({ dataRoot, scorePoint, updateData, updatePoint }: {
    ...
    const columns = useFormDanhGiaColumn({
        dataRoot,
        scorePoint,
        dataSource,
        setDataSource,
...
export default PhuLucComponent;
