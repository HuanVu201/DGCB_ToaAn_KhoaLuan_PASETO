...
import { DeleteOutlined, DeliveredProcedureOutlined, EditOutlined, EyeOutlined, LoadingOutlined, UnorderedListOutlined } from "@ant-design/icons";
...
import { useDanhGiaXepLoaiColumn } from "../hooks/useDanhGiaXepLoaiColumn";
...
import { TrangThai_ChoDanhGia } from "../../../common/TenVetXuLyConstants";
function ChoDanhGiaXepLoaiChamDiem() {
    ...
    const columns = useDanhGiaXepLoaiColumn({ pageNumber: searchParams.pageNumber ?? 1, pageSize: searchParams.pageSize ?? 10, tableActions })
...
const ChoDanhGiaXepLoaiChamDiemSwapper = () => (
    <ButtonActionProvider>
        <DanhGiaProvider>
            <ChoDanhGiaXepLoaiChamDiem />
        </DanhGiaProvider>
    </ButtonActionProvider>
);


export default ChoDanhGiaXepLoaiChamDiemSwapper;