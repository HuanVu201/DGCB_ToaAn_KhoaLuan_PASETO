...
import { useDanhGiaContext } from ".";

const CapNhatChamDiemContext = createContext<ICapNhatChamDiemContext | null>(null)

export interface ICapNhatChamDiemContext {
...
export const useCapNhatChamDiemContext = () => {
    const context = useContext(CapNhatChamDiemContext)
    if (!context)
        throw new Error("CapNhatChamDiemContext must be used inside CapNhatChamDiemContext.Provider")
    return context
}

export const CapNhatDanhGiaProvider = ({ children }: IWithChildren) => {
    ...
    return <CapNhatChamDiemContext.Provider value={{
        ...
        {children}
    </CapNhatChamDiemContext.Provider>
}