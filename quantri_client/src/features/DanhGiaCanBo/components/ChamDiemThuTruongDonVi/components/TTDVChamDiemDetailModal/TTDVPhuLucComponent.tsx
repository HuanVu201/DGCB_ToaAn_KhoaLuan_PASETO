...
import { useMauPhieuTTDVChamDiemColumn } from "../../hooks/useMauPhieuTTDVChamDiemColumn";



function PhuLucComponentTTDVChamDiem({ dataRoot, scorePoint, updateData, updatePoint }: {
    ...
    const columns = useMauPhieuTTDVChamDiemColumn({
        dataRoot,
        scorePoint,
        dataSource,
        setDataSource,
...
export default PhuLucComponentTTDVChamDiem;
