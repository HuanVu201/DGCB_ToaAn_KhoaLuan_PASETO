...
import { IChiTietDanhGia, IDanhGiaCanBo, ISearchDanhGiaCanBo, IUserDanhGia } from "../models";

class ChiTietDanhGiaService extends Service.BaseApi implements Service.ICrud<IChiTietDanhGia> {
    constructor() {
        super("chitietdanhgias")
    }
    ...
    AddListChiTietDanhGia(_data: Partial<Omit<IChiTietDanhGia[], keyof IBaseExt<string>>>): AxiosResponseWrapper {
        return axiosInstance.post(this._urlSuffix + "/AddListChiTietDanhGia", { Data: _data })
    }

    UpdateListChiTietDanhGia(_data: Partial<Omit<IChiTietDanhGia[], keyof IBaseExt<string>>>): AxiosResponseWrapper {
        return axiosInstance.put(this._urlSuffix + "/UpdateListChiTietDanhGia", { Data: _data })
    }
    
}

export const chiTietDanhGiaServiceApi = new ChiTietDanhGiaService()