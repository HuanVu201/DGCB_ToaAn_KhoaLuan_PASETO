...
import { useMauPhieuReadOnLyDanhGiaColumn } from "../hooks/useMauPhieuReadOnLyChamDiemColumn";



function PhuLucComponentReadOnlyDanhGia({ dataRoot, scorePoint }: {
    ...
    const columns = useMauPhieuReadOnLyDanhGiaColumn({
        scorePoint,
        dataSource,
        expandedRowKeys,
        onExpand,
...
export default PhuLucComponentReadOnlyDanhGia;
