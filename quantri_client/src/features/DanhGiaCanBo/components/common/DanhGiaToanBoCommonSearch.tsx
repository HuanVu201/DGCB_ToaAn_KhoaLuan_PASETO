...
export const DanhGiaToanBoCommonSearch = ({ searchParams, setSearchParams, searchParamOrigins, extraButtons, defaultVisible = false, setLoading, isDanhGiaDonVi = false }: {
