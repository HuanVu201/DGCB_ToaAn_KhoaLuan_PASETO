...
public abstract class BaseDbContext : MultiTenantIdentityDbContext<ApplicationUser, ApplicationRole, string, IdentityUserClaim<string>, ApplicationUserGroupRole, IdentityUserLogin<string>, ApplicationRoleClaim, IdentityUserToken<string>>
{
    ...
    {
        var auditEntries = HandleAuditingBeforeSaveChanges(!string.IsNullOrEmpty(_currentUser.GetUserGroupId()) ? new Guid(_currentUser.GetUserGroupId()) : _currentUser.GetUserId());
