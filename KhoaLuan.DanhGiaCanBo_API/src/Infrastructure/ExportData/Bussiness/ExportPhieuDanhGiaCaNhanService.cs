...
public class ExportPhieuDanhGiaCaNhanService : IExportPhieuDanhGiaCaNhan
{
    ...
    public ExportPhieuDanhGiaCaNhanService(IDapperRepository dapperRepository, IMediator mediator, IMinioService minioService, IConfiguration configuration)
    {
    ...
    public async Task<UrlPhieuDanhGiaDto> ExportPhieuDanhGiaCaNhan(GetDanhGiaDto data, string urlPhoi)
    {
        ...
        try
        {
            ...
            using (var stream = new MemoryStream(fileRes.ByteRes))
            {
                using (var rp = WordReport.Open(stream))
                {
                    ...
                    rp.SetTag("nguoiNhanXet", data.NguoiNhanXet ?? string.Empty);
                    rp.SetTag("nguoiThamMuu", data.NguoiThamMuu ?? string.Empty);
                    rp.SetTag("nguoiDanhGia", data.NguoiDanhGia ?? string.Empty);

                    if (!string.IsNullOrEmpty(data.TenDonVi))
                        rp.SetTag("tenDonVi", data.TenDonVi);

                    if (!string.IsNullOrEmpty(data.ChucVu))
                        rp.SetTag("chucVu", data.ChucVu);

                    if (!string.IsNullOrEmpty(data.ChucDanh))
                        rp.SetTag("chucDanh", data.ChucDanh);
                    ...
                    List<ChiTietDanhGiaDto> mauPhieus = new List<ChiTietDanhGiaDto>();
                    ...
                    if (mauPhieus.Count > 0)
                    {
                        ...
                        string chiTietDiemNhanXet = mauPhieus[0].ChiTietDiemNhanXet ?? string.Empty;
                        ...
                        _listPointOfTieuChi.Add(new PointObject1
                        {
                            ...
                            DiemNhanXet1 = !string.IsNullOrEmpty(chiTietDiemNhanXet) ? chiTietDiemNhanXet.Split("#")[0] : string.Empty,
                        ...
                        _listPointOfTieuChi.Add(new PointObject1
                        {
                            ...
                            DiemNhanXet1 = !string.IsNullOrEmpty(chiTietDiemNhanXet) ? chiTietDiemNhanXet.Split("#")[1] : string.Empty,
                        ...
                        _listPointOfTieuChi.Add(new PointObject1
                        {
                            ...
                            DiemNhanXet1 = !string.IsNullOrEmpty(chiTietDiemNhanXet) ? chiTietDiemNhanXet.Split("#")[2] : string.Empty,
                        ...
                        _listPointOfTieuChi.Add(new PointObject1
                        {
                            ...
                            DiemTuCham1 = mauPhieus[0].DiemTuDanhGia ?? string.Empty,
                            DiemNhanXet1 = mauPhieus[0].DiemNhanXet ?? string.Empty,
                            DiemThamMuu1 = mauPhieus[0].DiemThamMuu ?? string.Empty,
                            DiemLanhDaoDanhGia1 = mauPhieus[0].DiemLanhDaoDanhGia ?? string.Empty,

                        });
                        #endregion

                        #region Xử lý điểm của từng tiêu chí
                        List<TieuChiDanhGiaNooTreeDto> dataRequest = JsonConvert.DeserializeObject<TieuChiDanhGiaNooTreeDto>(mauPhieus[0].DataXuLyKhieuNai ?? mauPhieus[0].DataLanhDaoDanhGia ?? mauPhieus[0].DataThamMuu ?? mauPhieus[0].DataNhanXet ?? mauPhieus[0].DataTuDanhGia).DanhSachTieuChiCon;
                    ...
                    if (mauPhieus.Count > 1)
                    {
                        ...
                        string chiTietDiemNhanXet = mauPhieus[1].ChiTietDiemNhanXet ?? string.Empty;
                        ...
                        _listPointOfTieuChi.Add(new PointObject2
                        {
                            ...
                            DiemNhanXet2 = !string.IsNullOrEmpty(chiTietDiemNhanXet) ? chiTietDiemNhanXet.Split("#")[0] : string.Empty,
                        ...
                        _listPointOfTieuChi.Add(new PointObject2
                        {
                            ...
                            DiemNhanXet2 = !string.IsNullOrEmpty(chiTietDiemNhanXet) ? chiTietDiemNhanXet.Split("#")[1] : string.Empty,
                        ...
                        _listPointOfTieuChi.Add(new PointObject2
                        {
                            ...
                            DiemNhanXet2 = !string.IsNullOrEmpty(chiTietDiemNhanXet) ? chiTietDiemNhanXet.Split("#")[2] : string.Empty,
                        ...
                        _listPointOfTieuChi.Add(new PointObject2
                        {
                            ...
                            DiemTuCham2 = mauPhieus[1].DiemTuDanhGia ?? string.Empty,
                            DiemNhanXet2 = mauPhieus[1].DiemNhanXet ?? string.Empty,
                            DiemThamMuu2 = mauPhieus[1].DiemThamMuu ?? string.Empty,
                            DiemLanhDaoDanhGia2 = mauPhieus[1].DiemLanhDaoDanhGia ?? string.Empty,

                        });
                        #endregion

                        #region Xử lý điểm của từng tiêu chí
                        List<TieuChiDanhGiaNooTreeDto> dataRequest = JsonConvert.DeserializeObject<TieuChiDanhGiaNooTreeDto>(mauPhieus[1].DataXuLyKhieuNai ?? mauPhieus[1].DataLanhDaoDanhGia ?? mauPhieus[1].DataThamMuu ?? mauPhieus[1].DataNhanXet ?? mauPhieus[1].DataTuDanhGia).DanhSachTieuChiCon;
                        List<string> listRootTieuChi = new List<string>();
                        dataRequest.ForEach(item =>
                        {
                            listRootTieuChi.Add(item.MaTieuChi ?? string.Empty);
                    ...
                    if (mauPhieus.Count > 2)
                    {
                        ...
                        string chiTietDiemNhanXet = mauPhieus[2].ChiTietDiemNhanXet ?? string.Empty;
                        ...
                        _listPointOfTieuChi.Add(new PointObject3
                        {
                            ...
                            DiemNhanXet3 = !string.IsNullOrEmpty(chiTietDiemNhanXet) ? chiTietDiemNhanXet.Split("#")[0] : string.Empty,
                        ...
                        _listPointOfTieuChi.Add(new PointObject3
                        {
                            ...
                            DiemNhanXet3 = !string.IsNullOrEmpty(chiTietDiemNhanXet) ? chiTietDiemNhanXet.Split("#")[1] : string.Empty,
                        ...
                        _listPointOfTieuChi.Add(new PointObject3
                        {
                            ...
                            DiemNhanXet3 = !string.IsNullOrEmpty(chiTietDiemThamMuu) ? chiTietDiemThamMuu.Split("#")[2] : string.Empty,
                        ...
                        _listPointOfTieuChi.Add(new PointObject3
                        {
                            ...
                            DiemTuCham3 = mauPhieus[2].DiemTuDanhGia ?? string.Empty,
                            DiemNhanXet3 = mauPhieus[2].DiemNhanXet ?? string.Empty,
                            DiemThamMuu3 = mauPhieus[2].DiemThamMuu ?? string.Empty,
                            DiemLanhDaoDanhGia3 = mauPhieus[2].DiemLanhDaoDanhGia ?? string.Empty,

                        });
                        #endregion

                        #region Xử lý điểm của từng tiêu chí
                        List<TieuChiDanhGiaNooTreeDto> dataRequest = JsonConvert.DeserializeObject<TieuChiDanhGiaNooTreeDto>(mauPhieus[2].DataXuLyKhieuNai ?? mauPhieus[2].DataLanhDaoDanhGia ?? mauPhieus[2].DataThamMuu ?? mauPhieus[2].DataNhanXet ?? mauPhieus[2].DataTuDanhGia).DanhSachTieuChiCon;
                        List<string> listRootTieuChi = new List<string>();
                        dataRequest.ForEach(item =>
                        {
                            listRootTieuChi.Add(item.MaTieuChi ?? string.Empty);
                    ...
                    for (int i = 0; i < jArrTieuChi.Count; i++)
                    {
                        ...
                        if (jObj["TenTieuChiBold1"] != null && !string.IsNullOrEmpty(jObj["TenTieuChiBold1"].ToString()))
                        {
                            var obj = new TieuChiBoldMauPhieu1Object
                            {
                                ...
                                DiemNhanXetBold1 = jObj["DiemNhanXetBold1"]?.ToString() ?? string.Empty,
                        ...
                        if (jObj["TenTieuChi1"] != null && !string.IsNullOrEmpty(jObj["TenTieuChi1"].ToString()))
                        {
                            var obj = new TieuChiNormalMauPhieu1Object
                            {
                                ...
                                DiemNhanXet1 = jObj["DiemNhanXet1"]?.ToString() ?? string.Empty,
                        ...
                        if (jObj["TenTieuChiBold2"] != null && !string.IsNullOrEmpty(jObj["TenTieuChiBold2"].ToString()))
                        {
                            var obj = new TieuChiBoldMauPhieu2Object
                            {
                                ...
                                DiemNhanXetBold2 = jObj["DiemNhanXetBold2"]?.ToString() ?? string.Empty,
                        ...
                        if (jObj["TenTieuChi2"] != null && !string.IsNullOrEmpty(jObj["TenTieuChi2"].ToString()))
                        {
                            var obj = new TieuChiNormalMauPhieu2Object
                            {
                                ...
                                DiemNhanXet2 = jObj["DiemNhanXet2"]?.ToString() ?? string.Empty,
                        ...
                        if (jObj["TenTieuChiBold3"] != null && !string.IsNullOrEmpty(jObj["TenTieuChiBold3"].ToString()))
                        {
                            var obj = new TieuChiBoldMauPhieu3Object
                            {
                                ...
                                DiemNhanXetBold3 = jObj["DiemNhanXetBold3"]?.ToString() ?? string.Empty,
                        ...
                        if (jObj["TenTieuChi3"] != null && !string.IsNullOrEmpty(jObj["TenTieuChi3"].ToString()))
                        {
                            var obj = new TieuChiNormalMauPhieu3Object
                            {
                                ...
                                DiemNhanXet3 = jObj["DiemNhanXet3"]?.ToString() ?? string.Empty,
                    ...
                    string fileName = $"Phiếu đánh giá cá nhân_{DateTime.Now.ToString("dd_MM_yyyy_hh_mm_ss")}.docx";
                    ...
                    using (var streamOutput = new MemoryStream())
                    {
                        ...
                        var res = await _minioService.UploadFileWithStreamDocxReturnUrlAsync(data.Id, streamOutput, fileName, "", "PhieuDanhGiaCaNhan");
        ...
        if (index == 0)
        {
            data.ForEach(item =>
            {
                ...
                if (listRootTieuChi.Contains(item.MaTieuChi ?? string.Empty))
                {
                    ...
                    tieuChi.DiemNhanXetBold1 = item.DiemNhanXet != null ? item.DiemNhanXet.ToString() : string.Empty;
                ...
                else
                {
                    ...
                    tieuChi.DiemNhanXet1 = item.DiemNhanXet != null ? item.DiemNhanXet.ToString() : string.Empty;
        ...
        if (index == 1)
        {
            data.ForEach(item =>
            {
                ...
                if (listRootTieuChi.Contains(item.MaTieuChi ?? string.Empty))
                {
                    ...
                    tieuChi.DiemNhanXetBold2 = item.DiemNhanXet != null ? item.DiemNhanXet.ToString() : string.Empty;
                ...
                else
                {
                    ...
                    tieuChi.DiemNhanXet2 = item.DiemNhanXet != null ? item.DiemNhanXet.ToString() : string.Empty;
        ...
        if (index == 2)
        {
            data.ForEach(item =>
            {
                ...
                if (listRootTieuChi.Contains(item.MaTieuChi ?? string.Empty))
                {
                    ...
                    tieuChi.DiemNhanXetBold3 = item.DiemNhanXet != null ? item.DiemNhanXet.ToString() : string.Empty;
                ...
                else
                {
                    ...
                    tieuChi.DiemNhanXet3 = item.DiemNhanXet != null ? item.DiemNhanXet.ToString() : string.Empty;
    ...
    private class TieuChiBoldMauPhieu1Object
    {
        ...
        public string? DiemNhanXetBold1 { get; set; }
    ...
    private class TieuChiNormalMauPhieu1Object
    {
        ...
        public string? DiemNhanXet1 { get; set; }
    ...
    private class TieuChiBoldMauPhieu2Object
    {
        ...
        public string? DiemNhanXetBold2 { get; set; }
    ...
    private class TieuChiNormalMauPhieu2Object
    {
        ...
        public string? DiemNhanXet2 { get; set; }
    ...
    private class TieuChiBoldMauPhieu3Object
    {
        ...
        public string? DiemNhanXetBold3 { get; set; }
    ...
    private class TieuChiNormalMauPhieu3Object
    {
        ...
        public string? DiemNhanXet3 { get; set; }
