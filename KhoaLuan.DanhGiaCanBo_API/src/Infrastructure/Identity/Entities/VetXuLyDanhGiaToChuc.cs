...
public class VetXuLyDanhGiaToChuc : BaseEntity, IAggregateRoot, ISoftDelete
{
    ...
    public DanhGiaDonVi DanhGia { get; private set; }
    ...
    public VetXuLyDanhGiaToChuc()
    {
        CreatedOn = DateTime.Now;
    }
    public VetXuLyDanhGiaToChuc(DefaultIdType userId, DefaultIdType? buocXuLyId, DefaultIdType danhGiaId, string tenThaoTac, string tenBuocXuLy, string tenNguoiXuLy, string taiKhoanXuLy, bool laNguoiDaXuLy, DefaultIdType trangThaiDanhGiaId)
    {
    ...
    public VetXuLyDanhGiaToChuc SoftDelete(DefaultIdType? nguoiXoa)
    {
    ...
    public VetXuLyDanhGiaToChuc Restore()
    {
        DeletedOn = null;
        DeletedBy = null;
        return this;
