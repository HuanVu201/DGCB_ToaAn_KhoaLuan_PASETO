...
public class GetDanhSachDanhGiaQuery : PaginationFilter, IRequest<PaginationResponse<DSDanhGiaDto>>
{
    public string? TenDonViTK { get; set; }
    public string? MaDonViTK { get; set; }
    public string? ThoiGianQueryTK { get; set; }
