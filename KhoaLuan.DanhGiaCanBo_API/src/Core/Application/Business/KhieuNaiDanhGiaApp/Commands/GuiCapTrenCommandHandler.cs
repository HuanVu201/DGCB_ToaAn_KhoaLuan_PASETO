...
public class GuiCapTrenCommandHandler : IRequestHandler<GuiCapTrenCommand, Result>
{
    ...
    public GuiCapTrenCommandHandler(IDapperRepository dapperRepository, IVetXuLyDanhGiaService vetXuLyDanhGiaService, ICurrentUser currentUser, IRepositoryWithEvents<DanhGia> repositoryWithEvents, IUserGroupService userGroupService, IMediator mediator)
    {
    ...
    public async Task<Result> Handle(GuiCapTrenCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            string sql = $@"
                UPDATE [Business].[KhieuNaiDanhGias]
        ...
        {
            throw new Exception("Lỗi gửi khiếu nại, kiến nghị: " + ex.Message);
        }
