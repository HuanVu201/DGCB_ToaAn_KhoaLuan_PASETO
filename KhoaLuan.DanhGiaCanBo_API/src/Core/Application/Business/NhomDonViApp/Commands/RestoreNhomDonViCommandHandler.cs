...
public class RestoreNhomDonViCommandHandler : ICommandHandler<RestoreNhomDonViCommand>
{
    private readonly IRepositoryWithEvents<NhomDonVi> _repositoryWithEvents;
    public RestoreNhomDonViCommandHandler(IRepositoryWithEvents<NhomDonVi> repositoryWithEvents) => _repositoryWithEvents = repositoryWithEvents;
    public async Task<Result> Handle(RestoreNhomDonViCommand request, CancellationToken cancellationToken)
    {
